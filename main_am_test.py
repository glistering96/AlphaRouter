...
from src.common.utils import dict_product, load_json, save_json, cal_average_std, collect_all_checkpoints, get_result_dir
    ...
    for env_type in ['tsp', 'cvrp']:
        for load_from in [20, 50, 100]:
            for test_num in [20, 50, 100]:
                ...
                path_format = f"./result_summary/cross_test_result/am/trained_on-{load_from}-test_on-{test_num}"
                for result_dir in result.keys():            
                    path = f"{path_format}/{result_dir}"
